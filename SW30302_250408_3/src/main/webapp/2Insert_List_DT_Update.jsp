			...
			<table border="1" style="text-align: center;">
				...
				<tr>
					...
					<td><input type="text" name="jumin"
						value="<%=rs.getString("jumin")%>">예) 710101-1000001</td>
				</tr>
				<tr>
					<td>백신코드</td>
					<td><input type="text" name="vcode"
						value="<%=rs.getString("vcode")%>">예) V001-V003</td>
				</tr>
				<tr>
					<td>병원코드</td>
					<td><input type="text" name="hospcode"
						value="<%=rs.getString("hospcode")%>">예) H001</td>
				</tr>
				<tr>
					<td>예약일자</td>
					<td><input type="text" name="resvdate"
						value="<%=rs.getString("resvdate")%>">"예)20211231</td>
				</tr>
				<tr>
					<td>예약시간</td>
