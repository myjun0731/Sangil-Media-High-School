...
<%
	...
	String sql = "select title, contents from board_tbl where bid = "+id;
...
<body>
	...
	<form action="EditConfirm.jsp" name="sibal">
		...
		<table>
			<tr>
				<td>제목</td>
				<td><input type="text" name="title" required value="<%=rs.getString(1)%>">
				<input type="hidden" name="id" value="<%=id%>"></td>
			</tr>
			<tr>
				<td>내용</td>
				<td><textarea name="content" rows="10" required style="resize: none;"><%=rs.getString(2)%></textarea></td>
			</tr>
			<tr>
